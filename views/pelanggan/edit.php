            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" class="needs-validation" novalidate>
                        ...
                        <!-- Tambahkan di dalam form, setelah field status -->
<div class="row mt-3">
    <div class="col-md-12">
        <h6 class="font-weight-bold text-primary">Konfigurasi MikroTik</h6>
        <hr>
    </div>
    <div class="col-md-4 mb-3">
        <label for="mikrotik_comment" class="form-label">MikroTik Comment</label>
        <input type="text" class="form-control" id="mikrotik_comment" name="mikrotik_comment" 
               value="<?php echo $data['mikrotik_comment'] ?? $data['id_pelanggan']; ?>"
               placeholder="user_<?php echo $data['id_pelanggan']; ?>">
        <div class="form-text">Digunakan untuk identifikasi di MikroTik</div>
    </div>
    <div class="col-md-4 mb-3">
        <label for="mikrotik_ip" class="form-label">IP Address</label>
        <input type="text" class="form-control" id="mikrotik_ip" name="mikrotik_ip" 
               value="<?php echo $data['mikrotik_ip']; ?>"
               placeholder="192.168.1.100">
        <div class="form-text">IP Address pelanggan (opsional)</div>
    </div>
    <div class="col-md-4 mb-3">
        <label for="mikrotik_profile" class="form-label">Bandwidth Profile</label>
        <select class="form-select" id="mikrotik_profile" name="mikrotik_profile">
            <option value="default" <?php echo $data['mikrotik_profile'] == 'default' ? 'selected' : ''; ?>>Default</option>
            <option value="1mbps" <?php echo $data['mikrotik_profile'] == '1mbps' ? 'selected' : ''; ?>>1 Mbps</option>
            <option value="2mbps" <?php echo $data['mikrotik_profile'] == '2mbps' ? 'selected' : ''; ?>>2 Mbps</option>
            <option value="5mbps" <?php echo $data['mikrotik_profile'] == '5mbps' ? 'selected' : ''; ?>>5 Mbps</option>
            <option value="10mbps" <?php echo $data['mikrotik_profile'] == '10mbps' ? 'selected' : ''; ?>>10 Mbps</option>
        </select>
    </div>
</div>
